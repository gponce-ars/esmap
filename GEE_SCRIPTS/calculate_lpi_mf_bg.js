...
GEE_link: https://code.earthengine.google.com/372fe33f7a497caccf2adcc04b5af4c8?noload=true
Goals: 
...
Description:
  This script calculate the metrics of LPI,MF, PCT_BG within the ground-surveyed polygons. Each of these polygons has 
  an attribute with the corresponding ecological state. The metrics calculated are exported as point-based datasaet 
  with the attributes for the ecological site identification and the three metrics.
Outputs
  - Satellited-based grids overlaping with the flights footprints in the SLUD
